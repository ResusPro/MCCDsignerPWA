(() => {
    ...
    document.getElementById('app').innerHTML = `
      <header class="app-header">
        <div>
          ...
          <h1>MCCDSigner PWA <span>v0.5.1</span></h1>
      ...
      <main>
        <section class="warning-card">
          ...
          <p><code>${safe}</code></p>
          <p>Reload once. If it persists, check that <code>app-v0.5.1.js</code> is visible at the repository root.</p>
        </section>
      </main>`;
  };
  ...
  import('./app-v0.5.1.js?build=051')
    .catch((error) => {
