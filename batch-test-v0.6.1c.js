(() => {
  ...
  async function downloadResults() {
    ...
    try {
      ...
      a.href = url; a.download = `MCCDSigner-v0.6.1c-batch-results-${new Date().toISOString().slice(0,10)}.zip`; document.body.append(a); a.click(); a.remove();
