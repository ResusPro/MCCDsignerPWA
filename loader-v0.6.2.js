(() => {
  ...
  function fail(detail) {
    ...
    if (!app) return;
    app.innerHTML = `<header class="app-header"><div><p class="eyebrow">STARTUP CHECK</p><h1>MCCDSigner PWA <span>v${VERSION}</span></h1><p class="subtitle">The page loaded, but the application could not start.</p></div></header><main><section class="warning-card"><strong>Startup failed</strong><p>${esc(detail)}</p><p>Confirm these files are at the repository root:</p><p><code>loader-v0.6.2.js</code><br><code>app-v0.6.2.js</code><br><code>app-v0.6.2.css</code><br><code>pdf.worker.mjs</code></p></section></main>`;
  }
  ...
  import('./app-v0.6.2.js?build=060')
